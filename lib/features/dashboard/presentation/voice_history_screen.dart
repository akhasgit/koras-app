...
/// Voice history — standalone page reached from the "Your voice" tab's
/// history icon. Deliberately independent from the Reads tab
/// (`assessment_history_screen.dart`): the two happen to look similar today,
/// but each is free to evolve on its own without affecting the other.
class VoiceHistoryScreen extends ConsumerWidget {
          ...
          body: history.when(
            ...
            data: (items) {
              ...
              return RefreshIndicator(
                ...
                child: ListView(
                  padding: EdgeInsets.only(top: statusBarH + 8, bottom: 32),
                  children: [
                    KorasHeader(
                      ...
                      onBack: () => context.canPop()
                          ? context.pop()
                          : context.go('/app/dashboard/progress'),
                    ),
                    Padding(
...
class _HistoryCard extends StatelessWidget {
  const _HistoryCard({required this.assessment});
